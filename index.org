...
#+BEGIN_SRC scheme
  (define (desert-hacker)
  (let ((location 'New-Mexico)
        (mood 'happily)
        (activity '(hacking podcasting))
        (link "https://www.youtube.com/@sudoshred"))
    (display
     (string-append
      (symbol->string mood)
      " "
...
[[./Adam_Schaefers_Shortened_Resume.pdf][Adam_Schaefers_Shortened_Resume.pdf]]
